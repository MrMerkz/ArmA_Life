...
donatorlevel1 = ["138711622","112270790","112270790","","","","","","","","","","","","","",""];
donatorlevel2 = ["30508038","110054790","105846214","12109510","130185798","","","","","","","","","","","","",""];
donatorlevel3 = ["135279750","136186886","105846214","12109510","139525126","136186886","110054790","138479366","92922950","123056454","12960070","30262022","129708870","64860806","30508038","105846214","129310342","",""];
donatorlevelclassA = ["82958150","37965510","135279750","86900294","109834182","140292934","","","","","","","","","","",""];

if ((getPlayerUID player) in adminlevel1) then {['geld',10000] call INV_AddInvItem};
if ((getPlayerUID player) in adminlevel2) then {['geld',20000] call INV_AddInvItem};
if ((getPlayerUID player) in donatorlevel1) then {['geld',7800] call INV_AddInvItem};
if ((getPlayerUID player) in donatorlevel2) then {['geld',8500] call INV_AddInvItem};
if ((getPlayerUID player) in donatorlevel3) then {['geld',10000] call INV_AddInvItem};
if ((getPlayerUID player) in donatorlevelclassA) then {['geld',15000] call INV_AddInvItem};
...
{
	donatorcashbonus = 9500;
};
if ((getPlayerUID player) in donatorlevel3) then
{
	donatorcashbonus = 12000;
};
if ((getPlayerUID player) in donatorlevelclassA) then
{
	donatorcashbonus = 15000;
};
//=================================================================================

//=================================================================================
INV_smscost		 = 100;
add_civmoney		 = 1000+admincashbonus+donatorcashbonus;
add_copmoney		 = 3500+admincashbonus+donatorcashbonus;
add_workplace		 = 3000;
...
deadtimebonus            = 0.001;       															
deadtimes                = 0;
suicidepenalty		 = 10; //Suicide penalty does not apply to cops
CopsKilled               = 0;           									
CivsKilled               = 0;           												
SelfKilled               = 0;
killstrafe               = 20000;			
...
GesetzAnzahl             = 12;         				
GesetzArray              = ["Always Drive on the RIGHT side of the road","Always Holster weapons in Towns.","Speed limits 60 in town 90 out", "Governor and Gaurds May have any weapon unlicensed","Governor is not immune to traffic laws","","","","","","","","","",""];
