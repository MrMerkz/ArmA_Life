...
//==================================== PRIVATE STORAGE ================================================
action50 = _role addaction ["A2L's Private storage (saved)","storage.sqf",["private_storage", "save"],1,false,true,"","player distance storage < 7"];
//========================================= BAIL ======================================================	 
...
action222 = _role addaction ["EG | Take Saved Vehicle out","retrievevehicle.sqf",[],1,false,true,"","player distance savepoint <= 3"];
action223 = _role addaction ["[*EG | SAVE YOUR VEHICLE*]","noscript.sqf",'(nearestobjects [getpos player, ["Air", "LandVehicle"], 3] select 0) execVM "saveVehicle.sqf";',1,true,true,"",'_vcl = (nearestobjects [getpos player, ["Air",  "LandVehicle"], 3] select 0);player distance savepoint < 10 and _vcl in INV_ServerVclArray and _vcl in INV_VehicleArray'];