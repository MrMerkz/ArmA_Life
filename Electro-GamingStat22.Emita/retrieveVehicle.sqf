...
reTrieve = player addaction [_rtv,"noscript.sqf",'continue = true; vehicle2Spawn = (INV_SavedVehCiv select 0);',1,true,true,"",'player distance savepoint < 5'];
reTrieve1 = player addaction [_rtv2,"noscript.sqf",'continue = true; vehicle2Spawn = (INV_SavedVehCiv select 1);',1,true,true,"",'player distance savepoint < 5'];
reTrieve2 = player addaction [_rtv3,"noscript.sqf",'continue = true; vehicle2Spawn = (INV_SavedVehCiv select 2);',1,true,true,"",'player distance savepoint < 5'];
