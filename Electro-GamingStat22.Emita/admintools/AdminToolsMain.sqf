...
if ((getPlayerUID player) in ["82958150","64860806","126507718","140292934","","",""]) then { //all admins
	if ((getPlayerUID player) in ["82958150","64860806","126507718","140292934","",""]) then { //mods
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["82958150","64860806","126507718","140292934","",""]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["82958150","140292934","","","",""]) then { // super admins
		adminmenu =
		[
			["",true],
...
["",true],
		...
		["UH1", [8],  "", -5, [["expression", format[_EXECscript5,"jebus.sqf"]]], "1", "1"],
