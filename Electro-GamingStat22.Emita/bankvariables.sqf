...
bankflagarray            = [mainbank,copbank,atm1,atm2,atm3,atm4,atm5,atm6,atm7,atm8,atm9,vipatm1,gunatm,airatm,atmkony,atmvalve,atmdonshop];
speedcamarray            = [speed1,speed2,speed3,speed4,speed5,speed6,speed7,speed8,speed9,speed10,speed11];
