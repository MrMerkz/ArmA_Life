...
*/
//=======================   ADMIN CAMERA ==============================================
action12 = _role addaction ["Activate Admin Spectate Menu","tcgcode.sqf",[1],1,false,true,"","player distance rubblepile <= 3"];
...
action35 = _role addaction ["Gather Organs","bodypart.sqf",'',1,true,true,"",'player distance (nearestobjects [getpos player, ["body"],  3] select 0) < 2'];
...
action166 = _role addAction ["Steal Government salaries", "stealgovmoney.sqf",[""],1,false,true,"","isciv and (call INV_isArmed) and player distance convoytruck <= 5"];
//======================================== GANG FLAGS ===================================================
