...
_coparrest = (nearestobjects [getpos player, ["tcg_police_officerk9","tcg_police_officer","FOX_US_SFMRW_OFFD","policeman","vilas_sira_sheriffoff","VIL_ctl_policeman_rd","vilas_sira_swat_m416","VIL_ctl_policeman","KPFS_Policeman_vest_des","KPFS_Policeman_vest_des_cap","vilas_sira_swat","FR_Marksman","vilas_sira_policeman"], 3] select 1);
