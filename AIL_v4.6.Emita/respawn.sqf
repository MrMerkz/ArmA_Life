...
//	[] execVM "rifleControl.sqf";
	...
	player addweapon "ItemGPS";
		switch _civ do
		{
		case civ46: {player setpos getmarkerpos "emsspawn";};
		case civ47: {player setpos getmarkerpos "emsspawn";};
		case civ48: {player setpos getmarkerpos "emsspawn";};	
...
if (iscop) then
{
	...
	isdead = 0;
   	_civnum = player;
	if (_civnum == cop7) then {player setPos getPos deputyspawn;};
