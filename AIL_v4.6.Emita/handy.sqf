...
buttonSetAction [4, "[""handy3"", ctrlText 1, call compile lbData [2, lbCurSel 2]] execVM ""handy.sqf""; closedialog 0;"];
...
//modified by bloodsport W.I.P
if (_art == "handy3") then {

_rolestring = getPlayerUID vehicle player;
_smstext   = _this select 1;
_playerPos = 0;
_playerPos = getPos player; 
_markername = _rolestring;

if (_smstext == "") exitWith {player groupChat localize "STRS_NO_COPMESAGE";};
if ((_smstext call ISSE_str_Length) > 20)exitWith {player groupChat localize "STRS_NO_COPMESSAGE_TOLONG";};	
		
_checkmarkerexistance = getMarkerType "_markername";
if (_checkmarkerexistance != "") then {deleteMarkerLocal "_markername";};


_markerrams = createMarkerLocal ["_markername", _playerPos];
"_markername" setMarkershape "icon";
"_markername" setMarkerColor "ColorRed";
"_markername" setMarkerSize [1, 1];
"_markername" setMarkerType "Marker";
"_markername" setMarkerText _smstext;

player groupchat format ["The police have recieved your call standby!"];

server globalChat "Someone has called 911 check your map!";
