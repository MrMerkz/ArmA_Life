...
_assa = ["kyo_ultralight","AH6X_EP1","CSJ_Gyroc","Mi17_Civilian","bd5j_civil_3","bd5j_civil_2","bd5j","GazelleUN","GazelleD","Gazelle","Gazelle1","Gazelle3","adf_as350","ibr_as350_specops","ibr_as350_jungle","tcg_bell206_3","tcg_bell206_4","tcg_bell206_1","tcg_bell206_2","tcg_bell206_5","tcg_bell206", "MH6J_EP1"];
...
//cop boat shop
_cb = ["JFH_USCG_ZODIAC","JFH_USCG_RHIB"];
//Terror Boat Shop
...
//Doctor
_td = ["firetruck","rescue","Laddertruck","suburban_fd","il_silverado_pd","tcg_suburban_FD","il_ambulance","il_f350_brush","gmc_ambulance","ibr_as350","roadcone","roadbarrierlong","roadbarriersmall","supgrade1","supgrade2","bjerk"];
//Resource Shop
...
[copboatshop, "Police Boat Shop",dummyobj,copboatspawn,_cb,_cb,true],
[tboatshop1,"Boat Shop",dummyobj,tboatspawn1,_bt,_bt,true],
[Diamond_1,"Jewelry Shop",dummyobj,dummyobj,_js,_js,true],
...
[cheeseburger,"Cheeseburgers",dummyobj,dummyobj,_gds,_gds,true],
[workplace_getjobflag_4,"TM Imporium",dummyobj,dummyobj,_gds1,_gds1,true],
...
[coptraffic,"Checkpoint Equipment",coptraffic,dummyobj,_trafficshop,_trafficshop,true],
[coptrafficcars,"Police Support Vehicles",dummyobj,ctrafficspawn,_trafficcars,_trafficcars,true],
[copvicecars,"Vice Unit Vehicles",dummyobj,ccarspawn2,_vicecars,_vicecars,true],
[copk9cars,"K9 Unit",dummyobj,ck9spawn,_k9cars,_k9cars,true],
[donatebuy,"Donator Shop",maindonateshop,maindonatespawn,_Donate,_Donate,true]
];
