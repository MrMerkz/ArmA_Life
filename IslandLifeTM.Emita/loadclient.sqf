...
//server globalChat format["Persistent stats loaded. Your donator reward is %1 and your admin reward is %2 which will be added to each salary paycheck.", donatorcashbonus, admincashbonus];
