...
case "Burglary": {
_logtext = format[localize "STRS_functions_crimelog_msg16", _zusatzinfo];
};

case "AttemptedBurglary": {
_logtext = format[localize "STRS_functions_crimelog_msg17", _zusatzinfo];
};
