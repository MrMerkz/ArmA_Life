...
switch (adminCMD) do
{
	...
	{
		  _O0O0 = player;
		 //'player groupchat "Video from the awesome Droo_k6"; ["Awesome\When_Im_Bored.ogv",1.04] call bis_fnc_customGPSvideo; closedialog 0;' call broadcast;
	...
	player groupChat "LOCKED TO [L4] ADMINS";
	};
