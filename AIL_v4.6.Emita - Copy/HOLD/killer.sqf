...
if (_killedbyvehicle) then 
	...
	{
	(format ["[""KilledCop"", %1, ""%2""] spawn Isse_AddCrimeLogEntry; if(%1 in civarray)then{if(!(""Cop Murder"" in %1_reason))then{%1_reason = %1_reason + [""Cop Murder""]}; kopfgeld_%1 = kopfgeld_%1 + 30000};", player,  _killer]) call broadcast;	
	};
