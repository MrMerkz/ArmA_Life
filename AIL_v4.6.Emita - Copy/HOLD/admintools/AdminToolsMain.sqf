...
if ((getPlayerUID player) in ["9479430","38008454","78444102","6823360","10248518","3788038","9535110","9571590","130750470","83080774,"109304006"]) then { //all admins

	if ((getPlayerUID player) in ["123456789","130750470"]) then { //mods
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["9535110","9571590","83080774","109304006"]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["9479430","38008454","78444102","6823360","10248518","3788038"]) then { // super admins
		adminmenu =
		[
			["",true],
