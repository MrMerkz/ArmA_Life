...
if (_art == "Use") then 
{
	...
	if (IsCop) exitwith {};
	if ((player distance marea1 < 200) or (player distance marea2 < 200) or (player distance marea3 < 200) or (player distance marea4 < 200)) then
	{
	...
	{
	player groupchat "You must be atleast 200m away from the center of a gang area.";
	};
