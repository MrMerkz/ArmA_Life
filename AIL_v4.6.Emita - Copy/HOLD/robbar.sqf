...
(format ['server globalChat "Someone robbed the Velvet Lounge!";']) call broadcast;
...
(format ['server globalChat "Someone robbed the Pig Street Bar!";']) call broadcast;
...
(format ['server globalChat "Someone robbed Ye Olde Pub!";']) call broadcast;
...
(format ['server globalChat "Someone robbed the Winchester Pub!";']) call broadcast;
