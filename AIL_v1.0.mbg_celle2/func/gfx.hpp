class GFX_GrafikEinstellungenDialog
{
	...
	class Sichtweite_button2 : RscButton	
	{
		...
		h = 0.04;
		text = "+100";
		action = "if (GFX_ArmaViewDistance <= 3400) then {GFX_ArmaViewDistance = GFX_ArmaViewDistance + 100; setViewDistance GFX_ArmaViewDistance; player groupChat format['Viewdistance: %1', GFX_ArmaViewDistance];};";
	};
